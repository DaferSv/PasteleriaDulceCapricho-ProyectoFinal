...
from .forms import ProductosForm, PedidosForm,  LaForm
...
def index(request):
    pastles_basicos = Productos.objects.filter(categoria='1').count()
    ...
    contexto = {
        'cuantos': cuantos,
        'pastles_basicos': pastles_basicos,
